  ...
  return (
    <div className="max-w-7xl mx-auto px-4 mt-20 sm:mt-16">
      <div className="max-w-lg mx-auto mb-8">
        <Skeleton className="h-10 w-48 mx-auto mb-6" /> {/* Title skeleton */}
        <div className="relative">
          <Skeleton className="h-14 w-full" /> {/* Search input skeleton */}
        ...
        {[...Array(12)].map((_, i) => (
          ...
          >
            ...
            <div className="p-3 pt-0 sm:p-4 flex flex-col gap-2 flex-1">
              <Skeleton className="h-6 w-3/4" /> {/* Product name skeleton */}
      ...
      <div className="flex justify-center mt-8">
        <div className="flex items-center gap-2">
          ...
          <Skeleton className="h-10 w-10 rounded-md" /> {/* Next page button */}
        </div>
      </div>
    </div>
  );
