...
export const getFooter = query({
  handler: async (ctx) => {
    ...
    // If no footer data exists, return default values
    if (!footer) {
      return {
        storeName: "تسوق",
        description:
        ...
        footerLinks: [
          {
            ...
            links: [
              ...
              { label: "الفئات", href: "/categories", order: 1 },
              { label: "المفضلة", href: "/wishlist", order: 2 },
              { label: "طلباتي", href: "/orders", order: 3 },
            ],
            order: 0,
          },
          {
            ...
            links: [
              ...
              { label: "الوظائف", href: "/careers", order: 2 },
              { label: "الشروط والأحكام", href: "/terms", order: 3 },
            ],
            order: 1,
          },
        ],
